...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // Загружаем погоду при открытии фрагмента
        loadWeather();
    ...
    private void loadWeather() {
        ...
        new Thread(() -> {
            String jsonResponse = downloadWeatherData();
    ...
    private void parseAndDisplayWeather(String json) {
        try {
            ...
            JsonObject currentWeather = root.getAsJsonObject("current_weather");
            ...
            tvWeatherDesc.setText("☁️ " + getWeatherDescription(weathercode));
